...
/** Экран добавления/редактирования офиса. */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun OfficeEditScreen(
    onBack: () -> Unit,
    onSaved: () -> Unit,
    viewModel: OfficeEditViewModel = viewModel(factory = OfficeEditViewModel.Factory)
) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(if (form.isEditing) "Редактировать офис" else "Новый офис") },
