...
/** Экран добавления/редактирования расхода автомобиля (месяц + категория + сумма). */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun VehicleExpenseEditScreen(
    onBack: () -> Unit,
    onSaved: () -> Unit,
    viewModel: VehicleExpenseEditViewModel =
        viewModel(factory = VehicleExpenseEditViewModel.Factory)
) {
    ...
    Scaffold(
        ...
        Column(
            ...
            EnumDropdown(
                label = "Категория",
                options = VehicleCategory.entries,
