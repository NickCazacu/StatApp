...
/** Экран «Советы» по офису — rule-based рекомендации (офлайн, без AI). */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun OfficeTipsScreen(
    onBack: () -> Unit,
    viewModel: OfficeTipsViewModel = viewModel(factory = OfficeTipsViewModel.Factory)
) {
...
private fun TipCard(tip: Tip) {
    // Цвет фона зависит от важности совета (как на экране советов рейса).
